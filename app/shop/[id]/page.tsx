          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-wrap items-center gap-2 mb-5">
              {inStock ? (
                <span className="inline-flex items-center gap-1 text-xs font-bold text-green-700 bg-green-50 border border-green-200 px-2.5 py-1 rounded-full">
                  <span className="w-1.5 h-1.5 rounded-full bg-green-500 inline-block" /> In Stock &nbsp;·&nbsp; {product.stock} units available
                </span>
              ) : (
            ...
            <div className="grid grid-cols-3 gap-3 border-t border-slate-100 pt-5">
              <div className="flex flex-col items-center text-center gap-1.5">
                ...
                <span className="text-xs text-slate-600 font-medium">Free Shipping All India</span>
              </div>
              <div className="flex flex-col items-center text-center gap-1.5">
